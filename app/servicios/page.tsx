...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      { es: "GEO: presencia en ChatGPT, Gemini, Google SGE y otros", en: "GEO: appear in ChatGPT, Gemini, Google SGE and more" },
      ...
      <main className="pt-28">
        ...
        <section className="relative py-24 md:py-40 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12 text-center">
            <span className="text-sm md:text-base lg:text-lg font-black tracking-[0.4em] text-primary uppercase">{t("services.label")}</span>
        ...
        <section className="py-16 md:py-32 bg-carbon-gray border-t border-white/5">
          <div className="max-w-3xl mx-auto px-6 md:px-12 text-center">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter mb-8">{t("svcpage.cta")}</h2>
