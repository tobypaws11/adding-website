      ...
      <main className="pt-20 page-enter">
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl font-black tracking-tight mt-4 md:mt-6 leading-tight">{t("whypage.approach.title")}</h2>
              </div>
        ...
        <section className="py-16 md:py-32 bg-carbon-gray border-y border-white/5">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="text-center mb-16 md:mb-24">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tight mt-4 md:mt-6">{t("whypage.diff.title")}</h2>
            </div>
        ...
        <section className="py-16 md:py-32 border-t border-white/5">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="text-center mb-16 md:mb-24">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tight mt-4 md:mt-6">{t("whypage.process.title")}</h2>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {steps.map((step, idx) => (
        ...
        <section className="py-16 md:py-32 bg-carbon-gray border-t border-white/5">
          <div className="max-w-3xl mx-auto px-6 md:px-12 text-center">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-8">{t("whypage.cta")}</h2>
