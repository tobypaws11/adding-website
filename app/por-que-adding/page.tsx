      ...
      <main className="pt-20">
        ...
        <section className="relative py-24 md:py-40 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12 text-center">
            <span className="text-[10px] font-black tracking-[0.6em] text-primary uppercase">{t("why.label")}</span>
        ...
        <section className="py-16 md:py-32 border-t border-white/5">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <div>
                <span className="text-[10px] font-black tracking-[0.6em] text-primary uppercase">{t("whypage.approach.label")}</span>
                <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mt-4 md:mt-6 leading-tight">{t("whypage.approach.title")}</h2>
              </div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="relative p-6 md:p-8 border border-white/5 bg-matte-black group hover:border-primary/30 transition-all">
                    ...
                    <h4 className="text-sm font-black uppercase tracking-widest mb-2">{t(`hero.fly.${i}`)}</h4>
                    {i < 4 && (
        ...
        <section className="py-16 md:py-32 bg-carbon-gray border-y border-white/5">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="text-center mb-16 md:mb-24">
              <span className="text-[10px] font-black tracking-[0.6em] text-primary uppercase">{t("whypage.diff.label")}</span>
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mt-4 md:mt-6">{t("whypage.diff.title")}</h2>
            </div>
            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-8">
              {differentiators.map((d, idx) => (
                <div key={d.key} className="component-module brushed-texture p-8 md:p-12 relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-black uppercase tracking-luxury mb-4">{t(`whypage.${d.key}.title`)}</h3>
        ...
        <section className="py-16 md:py-32 border-t border-white/5">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="text-center mb-16 md:mb-24">
              <span className="text-[10px] font-black tracking-[0.6em] text-primary uppercase">{t("whypage.process.label")}</span>
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mt-4 md:mt-6">{t("whypage.process.title")}</h2>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {steps.map((step, idx) => (
                <div key={step.key} className="relative border border-white/10 bg-carbon-gray p-8 md:p-12 group hover:border-primary/30 transition-all">
                  ...
                  <h4 className="text-lg font-black uppercase tracking-widest mb-3">{t(`whypage.${step.key}.title`)}</h4>
        ...
        <section className="py-16 md:py-32 bg-carbon-gray border-t border-white/5">
          <div className="max-w-3xl mx-auto px-6 md:px-12 text-center">
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-8">{t("whypage.cta")}</h2>
