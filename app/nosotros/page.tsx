      ...
      <main className="pt-28">
        ...
        <section className="relative py-24 md:py-40 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12 text-center">
            <span className="text-sm font-black uppercase tracking-[0.4em] text-primary">{t("nav.nosotros")}</span>
        ...
        <section className="py-16 md:py-32">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 space-y-16 md:space-y-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <div>
                <span className="text-sm font-black uppercase tracking-[0.4em] text-primary">{t("about.mission.label")}</span>
            ...
            <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <div className="lg:order-2">
                <span className="text-sm font-black uppercase tracking-[0.4em] text-primary">{t("about.vision.label")}</span>
        ...
        <section className="py-16 md:py-32 bg-carbon-gray border-y border-white/5">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            <div className="text-center mb-16 md:mb-24">
              <span className="text-sm font-black uppercase tracking-[0.4em] text-primary">{t("about.values.label")}</span>
