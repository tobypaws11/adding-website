  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-white to-brand-light px-6 py-16">
      <section className="w-full max-w-2xl rounded-3xl border border-black/5 bg-white p-10 text-center shadow-card">
        <p className="text-xs font-medium uppercase tracking-[0.2em] text-primary">Blog AdDing</p>
        <h1 className="mt-4 font-title text-4xl font-bold leading-tight text-white md:text-5xl">Estamos preparando contenido que te va a servir de verdad.</h1>
