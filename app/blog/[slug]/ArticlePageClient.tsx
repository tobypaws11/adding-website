    ...
    <section className="mt-16 border-t border-white/10 pt-12">
      ...
      <div className="space-y-2">
        {items.map((item, i) => {
          ...
          return (
            <div key={i} className={`border transition-colors duration-200 ${isOpen ? "border-primary/40 bg-primary/5" : "border-white/10 bg-white/[0.02]"}`}>
              <button
              ...
              >
                ...
                <span className={`shrink-0 text-primary transition-transform duration-300 ${isOpen ? "rotate-45" : "rotate-0"}`}>
