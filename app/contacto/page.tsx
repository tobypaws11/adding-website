      ...
      <main className="pt-28">
        ...
        <section className="relative py-24 md:py-40 overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12 text-center">
            <span className="text-base font-black uppercase tracking-[0.4em] text-primary">{t("nav.contacto")}</span>
        ...
        <section className="py-16 md:py-24">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            ...
            <div className="mt-16 md:mt-24 text-center">
              <h4 className="text-base font-black uppercase tracking-[0.4em] text-primary mb-8">{t("contact.social.title")}</h4>
