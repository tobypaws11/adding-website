...
export default function TerminosPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 pb-20 pt-32 md:pt-40">
      ...
      <h1 className="mt-6 font-title text-4xl font-bold text-brand-black">Términos y Condiciones</h1>
      ...
      <div className="prose mt-8 max-w-none text-black/75">
        ...
        <p>
          ...
          <strong> 3-102-862791</strong>, con domicilio en San José, Costa Rica, bajo la marca comercial
          <strong> AdDing Agency</strong>.
        </p>
