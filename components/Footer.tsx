...
const socials = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/addingagencydotcom",
    icon: <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />,
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/addingagencydotcom/",
  ...
  {
    label: "X",
    href: "https://x.com/AdDingAgencydot",
    icon: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />,
  },
  {
    label: "YouTube",
    href: "https://www.youtube.com/channel/UC_-MOkVciT3NcvtKmUG22Lw",
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@addingagencydotcom",
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/addingagencydotcom/",
    icon: <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />,
  },
  {
    label: "Pinterest",
    href: "https://www.pinterest.com/addingagencydotcom/",
  ...
  },
  {
    ...
    href: "https://maps.app.goo.gl/w57cSZzompNtixjR8",
  ...
  {
    label: "Threads",
    href: "https://www.threads.com/@addingagencydotcom",
    icon: <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.028-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.964-.065-1.19.408-2.285 1.33-3.082.88-.76 2.119-1.207 3.583-1.291a13.853 13.853 0 0 1 3.02.142c-.126-.742-.375-1.332-.75-1.757-.513-.586-1.308-.883-2.359-.89h-.029c-.844 0-1.992.232-2.721 1.32L7.734 9.258c.919-1.424 2.386-2.207 4.173-2.207h.043c3.011.019 4.862 1.989 5.09 5.392a10.486 10.486 0 0 1 1.473.931c1.243.99 2.073 2.326 2.38 3.747.45 2.047-.019 4.948-2.349 7.212C16.856 23.733 14.786 24 12.186 24zm.645-10.22c-.032 0-.063 0-.094.002-1.298.072-2.33.491-2.745.858-.365.32-.52.702-.49 1.207.022.406.237.763.605 1.004.485.314 1.193.49 1.934.449 1.071-.058 1.87-.519 2.375-1.373.357-.601.558-1.39.595-2.353a11.851 11.851 0 0 0-2.18-.794z" />,
  },
];
...
export function Footer() {
  ...
  return (
    <footer className="relative bg-matte-black border-t border-white/8">
      {/* Blue accent top bar */}
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-14 md:py-20">
        ...
        {/* Main grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-12 mb-10 md:mb-14 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 text-sm text-white/50">
              <a
                href="mailto:hola@addingagency.com?subject=Consulta%20desde%20addingagency.com"
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            <h5 className="text-xs font-black uppercase tracking-[0.4em] text-white">
              {t("footer.servicios")}
            </h5>
            <ul className="flex flex-col gap-2.5">
              {[
                ...
                <li key={s.id}>
                  <Link
                    href={`/servicios#${s.id}`}
                    className="text-sm text-white/45 hover:text-primary transition-colors leading-snug"
                  >
                    {s.title}
                  </Link>
                </li>
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 inline-block bg-primary text-white text-xs font-black tracking-[0.15em] uppercase px-6 py-3 hover:bg-primary/90 transition-colors w-fit"
            >
              {lang === "es" ? "AGENDÁ UNA LLAMADA" : "BOOK A CALL"}
            </a>
          </div>
        </div>
        ...
        <div className="border-t border-white/8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/30">
          <span>
            © {year} CINTA MK FUTURISTA LIMITADA · CED. 3-102-862791
          </span>
