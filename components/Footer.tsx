...
const socials = [
  { label: "LinkedIn", href: "https://linkedin.com/company/addingagency", icon: <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/> },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-24 mb-24 md:mb-48">
          <div className="lg:col-span-6 space-y-8 md:space-y-16">
            <div className="flex items-center gap-4 md:gap-8">
              ...
              <span className="text-2xl md:text-3xl font-black tracking-luxury uppercase font-display">AdDing</span>
            </div>
            <p className="text-white/30 max-w-xl text-base md:text-lg font-light leading-relaxed tracking-tight-luxury">
              {t("footer.tagline")}
            </p>
            <div className="space-y-3 text-sm text-white/40">
              <div><a href="mailto:hola@addingagency.com" className="hover:text-primary transition-all">hola@addingagency.com</a></div>
              <div>
          ...
          <div className="lg:col-span-3 space-y-8 md:space-y-12">
            ...
            <ul className="space-y-4 md:space-y-6">
              {[t("svc.leads.title"), t("svc.auto.title"), t("svc.seo.title"), t("svc.web.title"), t("svc.ai.title")].map((s) => (
                <li key={s}><span className="text-xs font-bold text-white/40 uppercase tracking-luxury">{s}</span></li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-8 md:space-y-12">
            ...
            <ul className="space-y-4 md:space-y-6">
              <li><a href="#modules" className="text-xs font-bold text-white/40 hover:text-primary uppercase tracking-luxury transition-all">{t("nav.servicios")}</a></li>
              <li><a href="#hub" className="text-xs font-bold text-white/40 hover:text-primary uppercase tracking-luxury transition-all">{t("nav.porque")}</a></li>
              <li><a href="#contact" className="text-xs font-bold text-white/40 hover:text-primary uppercase tracking-luxury transition-all">{t("nav.contacto")}</a></li>
